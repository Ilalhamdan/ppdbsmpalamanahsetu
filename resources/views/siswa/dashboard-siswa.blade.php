...
<body>
    ...
    `;
            ...
            // Menghindari top:-9999px agar canvas tidak salah baca offset Y (yang bikin area kosong di atas PDF)
            ...
            const opt = {
                ...
                // Tambahkan scrollY: 0 agar hasil tangkapan html2canvas selalu dari posisi teratas (tidak terpengaruh scroll user)
                html2canvas: { scale: 3, useCORS: true, allowTaint: true, letterRendering: true, backgroundColor: '#ffffff', scrollY: 0 },
